...
const TopChartCard = ({ song, i, isPlaying, activeSong, handlePauseClick, handlePlayClick }) => (
  <div className="w-full flex flex-row hover:bg-[#4c426e] py-2 p-4 rounded-lg cursor-pointer mb-2 items-center">
        ...
        >
          {
              topPlays?.map((song) => (
                ...
                >
                  <Link to={`/artists/${song?.artists ? song?.artists[0]?.adamid : '137057909'}`}>
